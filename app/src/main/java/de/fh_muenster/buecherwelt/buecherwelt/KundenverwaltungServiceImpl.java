...
public class KundenverwaltungServiceImpl implements KundenverwaltungService{
    ...
    private static final String URL = "http://192.168.40.128:8080/buecherwelt/Kundenverwaltung";

    /**
     * TAG contains the class name and is used for logging.
     */
    private static final String TAG = KundenverwaltungServiceImpl.class.getName();
    ...
    public void kundeHinzufuegen(int id, String vorname, String nachname, String plz, String ort, String strasse, int hausnummer, String email, String benutzername, String passwort) throws NoSessionException {
        ...
        try {
            ...
            if (sessionId != 0) {
                result = new Kunde(id, vorname, nachname, plz, ort, strasse, hausnummer, email, benutzername, passwort);
